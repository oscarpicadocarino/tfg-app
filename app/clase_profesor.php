...
<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="errores_comunes.php?id_clase=<?= $id_clase ?>&id_asignatura=<?= $id_asignatura ?>" class="nav-link"><i class="bi bi-exclamation-circle"></i> Errores Comunes</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-100">
            <div class="feature-box">
                ...
                <a href="generar_actividad.php?id_clase=<?= $id_clase ?>" class="stretched-link"></a>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-100">
            <div class="feature-box">
                ...
                <p class="card-text">Consulta y gestiona todas las actividades asociadas a esta clase.</p>
                <a href="actividades.php?id_clase=<?= $id_clase ?>&id_asignatura=<?= $id_asignatura ?>" class="stretched-link"></a>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-100">
            <div class="feature-box">
                ...
                <a href="errores_comunes.php?id_clase=<?= $id_clase ?>&id_asignatura=<?= $id_asignatura ?>" class="stretched-link"></a>
            </div>
        </div>
    </div>
</div>
